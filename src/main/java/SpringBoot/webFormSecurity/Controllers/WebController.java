...
public class WebController {
    ...
    public String renderEditForm(@PathVariable("id") int id, @RequestParam boolean edit, Model mod)
    {
    ...
    public String saveEdittedForm(@ModelAttribute UsersEntity userEdit)
    {
